...
success {
  ...
  deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://35.161.112.225:8080/')],
...
success {
  ...
  deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://54.188.61.69:8080/')],
